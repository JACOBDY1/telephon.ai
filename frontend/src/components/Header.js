      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex flex-1 max-w-md">
          ...
          >
            ...
            <div className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 text-sm text-right hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
              {t?.search || 'חיפוש...'}
